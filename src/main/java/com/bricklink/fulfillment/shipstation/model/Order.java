...
public class Order {
    ...
    private Date createDate;                           // The timestamp the order was created in ShipStation's database. Read-Only.
    private Date modifyDate;                           // The timestamp the order was modified in ShipStation. modifyDate will equal createDate until a modification is made. Read-Only.
    ...
    private String externallyFulfilledBy;              // If externallFulfilled is true then this String will return how the order is being fulfilled by the marketplace. Read-Only.
